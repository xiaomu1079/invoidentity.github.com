...
public class AnimalFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mImage = view.findViewById(R.id.initImage_2);
        mImage.setImageResource(R.drawable.wallpaper);
        line = view.findViewById(R.id.progress_line_2);
        mChooseLocalImage = view.findViewById(R.id.local_image_2);
        ...
        mCapture = view.findViewById(R.id.capture_image_2);
        ...
        final ImageView mUpload = view.findViewById(R.id.upload_2);
    ...
    protected int services() {
        classify.detected();
        if (imagePath == null) {
            mBitmap = BitmapFactory.decodeResource(getResources(), R.id.initImage_2);
            json = classify.getClient().animalDetect(bitmapToByte.getArrays(), new HashMap<String, String>());
            return 2;
        } else {
            json = classify.getClient().animalDetect(bitmapToByte.getArrays(), new HashMap<String, String>());
            return 2;

package com.example.invo.plantidentification.ui.dish;
...
public class DishFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mImage = view.findViewById(R.id.initImage_3);
        mImage.setImageResource(R.drawable.wallpaper);
        line = view.findViewById(R.id.progress_line_3);
        mChooseLocalImage = view.findViewById(R.id.local_image_3);
        ...
        mCapture = view.findViewById(R.id.capture_image_3);
        ...
        final ImageView mUpload = view.findViewById(R.id.upload_3);
    ...
    protected int services() {
        classify.detected();
        if (imagePath == null) {
            mBitmap = BitmapFactory.decodeResource(getResources(), R.id.initImage_3);
            json = classify.getClient().dishDetect(bitmapToByte.getArrays(), new HashMap<String, String>());
            return 3;
        } else {
            json = classify.getClient().dishDetect(bitmapToByte.getArrays(), new HashMap<String, String>());
            return 3;
